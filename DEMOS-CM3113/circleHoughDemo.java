...
public class circleHoughDemo extends JApplet {
	
	Image edgeImage, accImage, outputImage;
	MediaTracker tracker = null;
	PixelGrabber grabber = null;
	int width = 0, height = 0;
	String fileNames[] = {"shapes.png","lena.png", "mit.png", "office1.png", "petrol.png"};
	...
	JLabel origLabel,linesLabel, circleLabel, outputLabel,edgeLabel,comboLabel,radiusLabel,intermediateLabel,processing;
	...
	public void init() {
		...
		linesLabel = new JLabel("Number Of Circles");
        ...
        timer = new javax.swing.Timer(50, new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
				int val=sobelObject.getProgress()/3+nonMaxSuppressionObject.getProgress()/3+hystThreshObject.getProgress()/3+(circleHoughObject.getProgress()*2);
				val=val/3;
